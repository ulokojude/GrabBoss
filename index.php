...
<body><!-- Navbar --><nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
  <div class="container">
...
</section><!-- Features --><section class="py-4 bg-light text-center">
  <div class="container">
    <div class="row g-3">
...
</section><!-- Categories --><section class="py-5">
  <div class="container">
...
</section><!-- Products --><section class="py-5 bg-light">
  <div class="container">
...
</section><!-- Newsletter --><section class="py-5 text-center text-white" style="background:#3a0ca3;">
  <div class="container">
...
</footer><script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js"></script></body>
</html>